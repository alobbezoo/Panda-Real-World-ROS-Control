...
for i in range(5):
    ...
    joint_goal0 = joint_angles[0]
    joint_goal1 = joint_angles[1]
    joint_goal2 = joint_angles[2]
    joint_goal3 = joint_angles[3]
    joint_goal4 = joint_angles[4]
    joint_goal5 = joint_angles[5]
    joint_goal6 = joint_angles[5]
    print(joint_goal0, joint_goal1, joint_goal2, joint_goal3, joint_goal4, joint_goal5, joint_goal6)
